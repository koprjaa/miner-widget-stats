...
class MinerWidget(rumps.App):
    ...
    def update_status_once(self):
        ...
        try:
            ...
            logger.exception("Chyba při získávání teploty")
            temp = "--"
        ...
        if profile and workers:
            try:
                ...
                logger.exception("Chyba při aktualizaci")
    ...
    def fetch_data(self):
        ...
        for attempt in range(MAX_RETRIES):
            try:
                ...
                logger.exception("Chyba při načítání dat (pokus {attempt + 1}/{MAX_RETRIES})")
    ...
    def update_status(self):
        ...
        while self.running:
            try:
                ...
                logger.exception("Chyba v aktualizačním vlákně")
                time.sleep(RETRY_DELAY)
